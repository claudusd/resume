...
\extrainfo{25 ans, Permis B}                 % optional, remove / comment the line if not wanted
...
\begin{document}
    ...
    \section{Expériences professionnelles}
        \cventry{\textit{Depuis Juin 2015}}{Architecte Symfony2}{IT Network}{}{}{Réalisation de projet avec Symfony2. Mise en place d'intégration et de déploiement continu \newline{}
avec Travis-CI et Capistrano.}
        \cventry{\textit{Janvier 2016\newline{}6 semaines}}{Enseignant vacataire}{Université d'Auvergne}{}{}{Enseignement du javascript au étudiant de la licence web.\newline{}
Préparation des cours et TP sur la norme ECMAScript 6, NodeJs, CSS réponsive et ReactJS.}
