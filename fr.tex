...
\ifpdf
    \pdfinfo {
        ...
        /Title (Claude Dioudonnat - Ingenieur Backend et Admin Sys)
        /Subject (SUBJECT)
        /Keywords (KEYWORDS)
        /CreationDate (D:20220304141100)
    }
\fi
...
\title{Ingenieur Backend \& Admin Sys}                               % optional, remove / comment the line if not wanted
...
\extrainfo{32 ans, Permis B}                 % optional, remove / comment the line if not wanted
...
\begin{document}
    ...
    \section{Expériences professionnelles}
        ...
        \cventry{
          \textit{Depuis Avril 2019 à Août 2020\newline{}1 ans 5 mois}
        }
...
\pagebreak
    \section{Associatif}
        \cventry{\textit{Depuis Janvier 2020}}{Volcamp}{}{}{}
        {
